...
- `th`表格的表头单元格
  ...
  <img src="assets/image-20220406172718137.png" alt="image-20220406172718137" style="zoom:80%;" />
...
- 布尔属性可以没有属性值，**写上属性名就代表使用这个属性**
  - 如果要给布尔属性设值，值就是属性名本身
    ...
    <img src="assets/image-20220406211008642.png" alt="image-20220406211008642" style="zoom:80%;" />
...
- `type`类型设置为`radio`，变成单选框: 
  ...
  - 默认选中：`checked`
    ...
    <img src="assets/image-20220406214827886.png" alt="image-20220406214827886" style="zoom:80%;" />
...
- `type`类型设置为`checkbox`，变成多选框：
  ...
  - 默认选中：`checked`
    ...
    <img src="assets/image-20220406214942184.png" alt="image-20220406214942184" style="zoom:80%;" />
...
- `! `和` html:5`可以快速生成完整结构的`html5`代码
  ...
  <img src="assets/image-20220406223558616.png" alt="image-20220406223558616" style="zoom:80%;" />

## 2. > (子代) 和 + (兄弟)

<img src="assets/image-20220406223657346.png" alt="image-20220406223657346" style="zoom:80%;" />

## 3. *（多个）和 ^（上一级）

<img src="assets/image-20220406223729441.png" alt="image-20220406223729441" style="zoom:80%;" />

## 4.（）分组

<img src="assets/image-20220406223844733.png" alt="image-20220406223844733" style="zoom:80%;" />

## 5. 属性(id属性、class属性、普通属性) {}（内容）

<img src="assets/image-20220406223908777.png" alt="image-20220406223908777" style="zoom:80%;" />

## 6. $（数字）

<img src="assets/image-20220406223930564.png" alt="image-20220406223930564" style="zoom:80%;" />

## 7. 隐式标签

<img src="assets/image-20220406224006064.png" alt="image-20220406224006064" style="zoom:80%;" />

## 8. CSS Emmet

<img src="assets/image-20220406224034009.png" alt="image-20220406224034009" style="zoom:80%;" />
