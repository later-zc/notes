...
- 媒体特性描述了 浏览器、输出设备，或是预览环境的**具体特征**
  ...
  - 每条媒体特性表达式都**必须用括号括起来**
    ...
    <img src="assets/image-20220501162309897.png" alt="image-20220501162309897" style="zoom:80%;" />	
...
- 以`iPhone`为例：
  ...
  <img src="assets/image-20220501162733373.png" alt="image-20220501162733373" style="zoom:80%;" />
...
- 理想视口（`ideal viewport`）：
  ...
  - 这个时候可以设置**`meta`中的`viewport`**
    ...
    <img src="assets/image-20220502180706789.png" alt="image-20220502180706789" style="zoom:80%;" />
