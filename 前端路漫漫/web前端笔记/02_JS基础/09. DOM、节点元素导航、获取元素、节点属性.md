...
- 浏览器会对我们编写的`HTML`、`CSS`进行渲染，同时它又要考虑我们可能会通过`js`来对其进行操作： 
  ...
  - 所有**这些对象**都**可以通过`js`**来对其**进行访问**，那么我们就可以**通过JavaScript来操作页面**
...
- 元素之间存在如下的关系：
  ...
  ![image-20220520183238101](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220520183238101.png)
