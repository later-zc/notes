...
- 什么是`pnpm`呢？我们来看一下官方的解释：
  ...
  ![image-20220723234850330](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723234850330.png)

- 哪些公司在用呢？

  - 包括`Vue`在内的很多公司或者开源项目的包管理工具都切换到了`pnpm`

  ![image-20220723234859874](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723234859874.png)
...
- 符号链接(软链接`soft link、Symbolic link`):
  ...
  ![image-20220723235127862](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723235127862.png)
...
- 文件的拷贝：文件的拷贝每个人都非常熟悉，会在硬盘中复制出来一份新的文件数据
  ...
  ![image-20220723235224017](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723235224017.png)
...
- 文件的硬链接
  ...
  ![image-20220723235249948](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723235249948.png)
...
- 文件的软连接：
  ...
  ![image-20220723235318220](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723235318220.png)
...
**![image-20220723235655287](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220723235655287.png)**

## 2.`pnpm`创建非扁平的`node_modules`目录

- 当使用`npm`或`Yarn Classic`安装依赖包时，所有软件包都将被提升到`node_modules`的根目录下

  - 其结果是，源码可以访问 本不属于当前项目所设定的依赖包

  ![image-20220724125952130](C:\Users\23634\AppData\Roaming\Typora\typora-user-images\image-20220724125952130.png)
